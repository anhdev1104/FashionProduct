const NotFound = () => {
    return `<div class="h-screen w-screen bg-primary flex items-center overflow-hidden">
    <div class="container flex flex-col md:flex-row items-center justify-center text-gray-700">
        <div class="max-w-md">
            ...
            <p class="text-2xl md:text-3xl font-light leading-normal">Oops! Page not found.</p>
            <p class="mb-8">We can't find the page you're looking for.</p>

            <a
                href="/" class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-700">
                Go back home
            </a>
        </div>
        <div class="max-w-lg">
            <svg id="a706cf1c-1654-439b-8fcf-310eb7aa0e00" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                class="w-80 ml-24" width="1120.59226" height="777.91584" viewBox="0 0 1120.59226 777.91584">
