import { getProductCollection } from '../api/product';
...
<main>
    ...
    <section class="w-full max-w-[1350px] mx-auto px-4 mt-[93px] select-none">
        ...
        <a href=""
            class="h-[50px] w-[220px] bg-transparent flex justify-center items-center border-solid border-2 border-second mx-auto mb-10 uppercase font-bold text-base transition-all ease-in-out duration-200 hover:bg-second hover:text-primary">VIEW
            MORE +</a>
    </section>
